    ...
    var app = sc.Definitions.App.extend({
        ...
        setDefaultDate: function () {
            ...
            fromDate = fromDate.getFullYear().toString()
                + ((fromDate.getMonth() + 1).toString().length == 1 ? "0" + (fromDate.getMonth() + 1).toString() : (fromDate.getMonth() + 1).toString())
            ...
            toDate = toDate.getFullYear().toString()
                + ((toDate.getMonth() + 1).toString().length == 1 ? "0" + (toDate.getMonth() + 1).toString() : (toDate.getMonth() + 1).toString())
